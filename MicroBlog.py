...
class MicroBlog(object):
    ...
    def get_user_info(self, selector):
        ...
        try:
            ...
            # //div[@class='tip2']/* : 选取所有div元素，并且这些元素的属性为class，且值为tip2
    ...
    def get_page_num(self, selector):
        ...
        try:
            # print('------Get Page_Num------')
            # //input[@name='mp']: 获取所有input元素，并且这些元素属性为name，值为mp
    ...
    def get_one_page(self, page):
        ...
        try:
            ...
            selector = self.deal_html(url)
            # //div[@class='c': 获取所有div元素，并且这些元素的属性为class，且值为c
            # div/span[@class='ctt']: 获取div的span子元素，且这些元素的属性为class，值为ctt
    ...
    def is_original(self, info):
        ...
        """
        # div/span[@class='cmt']: 获取div的span子元素，且该元素属性为class，且值为cmt
    ...
    def get_original_microblog(self, info, microblog_id):
        ...
        try:
            ...
            if u'全文' in a_text:
                ...
                """
                selector = self.deal_html(url)
                # //div[@class='c']: 获取div元素，且属性为class，值为c
                # //span[@class='ct']/text(): 获取span元素，且属性为class，值为ct
    ...
    def get_retweet_microblog(self, info, microblog_id):
        ...
        try:
            ...
            # div/span[@class='cmt']/a/text(): 获取div元素的子元素span，属性为class，值为cmt
    ...
    def extract_picture_urls(self, info, microblog_id):
        ...
        try:
            ...
            a_list:
                无图片时：
                    -len: 4
                    -0: https://weibo.cn/attitude/JhKEG6sp2/add?uid=7162252780&rl=0&st=969d63 微博界面
                    -1: https://weibo.cn/repost/JhKEG6sp2?uid=3566865465&rl=0 转发页面
                    -2: https://weibo.cn/comment/JhKEG6sp2?uid=3566865465&rl=0#cmtfrm 评论页面
                    -3: https://weibo.cn/fav/addFav/JhKEG6sp2?rl=0&st=969d63 微博界面
                有图片时：
                    -len: 7
                    -0: https://weibo.cn/mblog/picAll/Jo7OtF2mm?rl=1 所有图片
                    -1: https://weibo.cn/mblog/pic/Jo7OtF2mm?rl=0 第一张图片
                    -2: https://weibo.cn/mblog/oripic?id=Jo7OtF2mm&u=d49a0c39ly1gjh2ndzhmmj20u0140qg8 放大图片
                    -3: https://weibo.cn/attitude/Jo7OtF2mm/add?uid=7162252780&rl=0&st=969d63 微博界面
                    -4: https://weibo.cn/repost/Jo7OtF2mm?uid=3566865465&rl=0 转发界面
                    -5: https://weibo.cn/comment/Jo7OtF2mm?uid=3566865465&rl=0#cmtfrm 评论界面
                    -6: https://weibo.cn/fav/addFav/Jo7OtF2mm?rl=0&st=969d63 微博界面
            first_pic: 'https://weibo.cn/mblog/pic/JwV0zox7t?rl=0' 第一张图片
            all_pic: 'https://weibo.cn/mblog/picAll/JwV0zox7t?rl=1' 所有图片
            """
    ...
    def get_publish_place(self, info):
        ...
        try:
            ...
            if not 地理位置：
                ...
                a.xpath('@href'): 
                    ['https://weibo.cn/repost/Js6yq44KA?uid=5264532649&rl=0'] 
                    ['https://weibo.cn/comment/Js6yq44KA?uid=5264532649&rl=0#cmtfrm'] 
                    ['https://weibo.cn/fav/addFav/Js6yq44KA?rl=0&st=b2e1d6'] 
                    ['https://weibo.cn/sinaurl?f=w&u=http%3A%2F%2Ft.cn%2FEZuf0LW&ep=Jqwup9xdk%2C5264532649%2CJqwup9xdk%2C5264532649'] 
                    ['https://place.weibo.com/h5map_body.php?xy=116.477623,39.875039&backurl=https%253A%252F%252Fweibo.cn%252Fu%252F5264532649%253Fpage%253D1%2526amp%253Brand%253D7699']
                a.xpath('text()'): ['转发[0]']/['评论[0]']/['收藏']/['北京']/['显示地图']
            """
            for a in a_list:
                if 'place.weibo.com' in a.xpath('@href')[0] and a.xpath('text()')[0] == u'显示地图':
                    microblog_list = div_first.xpath("span[@class='ctt']/a")
                    """
                    div_first.xpath("span[@class='ctt']/a/text()"): ['#纪涵中[超话]#', '厦门·观音山梦幻世界乐园']
                    div_first.xpath("span[@class='ctt']/a/text()")[-1]: 厦门·观音山梦幻世界乐园
                    div_first.xpath("span[@class='ctt']/a/text()")[-1][-2:]: '乐园'
                    """
    ...
    def write_csv(self, wrote_num):
        ...
        try:
            ...
            """
            # file_dir = 'E:\\py_project\\Crawling of microblog information'
            # file_dir = os.path.split(os.path.realpath(__file__))[0]
            # file_dir = file_dir + os.sep + 'user_information' + os.sep + self.nickname
            # file_path = 'E:/py_project/Crawling of microblog information/user_information/可爱辰真的很可爱/5527986069.csv'
    ...
    def download_pictures(self):
        ...
        try:
            ...
            """
            img_dir: 图片存储路径
            pic_prefix: 图片名称前缀, such as '20201023 _Jqwup9xdk'
            pic_suffix: 图片名称后缀, such as 'jpg', 'png'
            pic_name: pic_prefix + (j + 1) + pic_suffix, such as '20201023 _Jqwup9xdk_1.jpg'
            pic_path: 图片地址, such as 'E:\\py_project\\weibo_analysis\\weibo\\_Shen_Oo\\img\\20201023 _Jqwup9xdk_1.jpg'
            """
            ...
            for w in tqdm(self.microblog, desc=u'图片下载进度'):
                if w['original_pictures'] != '无':
                    ...
                    if ',' in w['original_pictures']:
                        ...
                        pic_name = pic_prefix + pic_suffix  # such as 20161031 _EfmxrFIcj.jpg
                        pic_path = img_dir + os.sep + pic_name
                        """ 下载单张图片 """
                        # requests.get(): 用于请求目标网站
                        # response.content: 图片
